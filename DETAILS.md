...
[#] 1. HS01 | 14100000 | Type 3
    Back Top Row from left Port 1 USB 3.x Type A, 2.0 personality
    - SMART USB 8GB T
[#] 2. HS02 | 14200000 | Type 3
    Back Top Row from left Port 2 USB 3.x Type A, 2.0 personality
    - SMART USB 8GB T
[#] 3. HS03 | 14300000 | Type 3
    Back Bottom Row from left Port 3 USB 3.x Type A, 2.0 personality
    - SMART USB 8GB T
[#] 4. HS04 | 14400000 | Type 3
    Back Bottom Row from left Port 1 USB 3.x Type A, 2.0 personality
    - SMART USB 8GB T
[#] 5. HS05 | 14500000 | Type 3
    Back Bottom Row from left Port 2 USB 3.x Type A, 2.0 personality
    - SMART USB 8GB T
[#] 6. HS06 | 14600000 | Type 3
    Back Bottom Row from left Port 4 USB 3.x Type A, 2.0 personality
    - SMART USB 8GB T
[#] 7. HS08 | 14700000 | Type 0
    Front from Top Port 1 USB 2.x Type A
    - Dell USB Entry Keyboard
[#] 8. HS09 | 14800000 | Type 3
    Front from Top Port 3 USB 3.x Type A, 2.0 personality
    - Microsoft USB Optical Mouse
[#] 9. HS10 | 14900000 | Type 0
    Front from Top Port 2 USB 2.x Type A
    - Microsoft USB Optical Mouse
[#] 10. HS11 | 14a00000 | Type 3
    Front from Top Port 4 USB 3.x Type A, 2.0 personality
    - SMART USB 8GB T
[ ] 11. HS12 | 14b00000 | Type 3
[ ] 12. HS13 | 14c00000 | Type 3
[#] 13. SS01 | 14d00000 | Type 3
    Back Top Row from left Port 1 USB 3.x Type A, 3.0 personality
    - DataTraveler 3.0
[#] 14. SS02 | 14e00000 | Type 3
    Back Top Row from left Port 2 USB 3.x Type A, 3.0 personality
    - DataTraveler 3.0
[#] 15. SS03 | 14f00000 | Type 3
    Back Bottom Row from left Port 3 USB 3.x Type A, 3.0 personality
    - DataTraveler 3.0
[#] 16. SS04 | 14000000 | Type 3
    Back Bottom Row from left Port 1 USB 3.x Type A, 3.0 personality
    - DataTraveler 3.0
[#] 17. SS05 | 14100000 | Type 3
    Back Bottom Row from left Port 2 USB 3.x Type A, 3.0 personality
    - DataTraveler 3.0
[#] 18. SS06 | 14200000 | Type 3
    Front from Top Port 3 USB 3.x Type A, 3.0 personality
    - DataTraveler 3.0
[#] 19. SS07 | 14300000 | Type 3
    Front from Top Port 4 USB 3.x Type A, 3.0 personality
    - DataTraveler 3.0
[ ] 20. SS08 | 14400000 | Type 3
[#] 21. SS09 | 14500000 | Type 3
    Back Bottom Row from left Port 4 USB 3.x Type A, 3.0 personality
    - DataTraveler 3.0
...
> Note: All ports are working now. In the older clover patch I used to have the following ports disabled: `USB back, bottom row, 1rst from left`,`USB back, bottom row, 2nd from left`,`USB back, bottom row, 3rd from left`,`USB back, bottom row, 4rth from left`.
